        ...
        <main className="main-content">
          <header className="page-header">
            <div className="header-title">
              ...
              <p>
                Message clients over WhatsApp and SMS, and set up automated chat
                campaigns
              </p>
            </div>
          ...
          <div className="content-layout">
            ...
            <div className="channels-sidebar">
              ...
              <div className="channel-group active-group">
                <div className="channel-title">Website</div>
                <a href="inbox.html" className="channel-item">
                  Inbox
                </a>
                <a href="index.html" className="channel-item active">
                  Widget Settings
                </a>
              </div>
            </div>
